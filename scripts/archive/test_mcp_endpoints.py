...
def main():
    ...
    results.append(("GET /mcp/v1/tools/get_context",
                   test_endpoint(f"{server_url}/mcp/v1/tools/get_context", method="GET")))
    results.append(("POST /mcp/v1/tools/get_context",
                   test_endpoint(f"{server_url}/mcp/v1/tools/get_context", method="POST")))

    # Test memory tool
    results.append(("POST /mcp/v1/tools/memory (stats)",
                   test_endpoint(f"{server_url}/mcp/v1/tools/memory",
                                data={"operation": "stats"})))

    # Test item tool
    results.append(("POST /mcp/v1/tools/item (stats)",
                   test_endpoint(f"{server_url}/mcp/v1/tools/item",
                                data={"operation": "stats"})))
