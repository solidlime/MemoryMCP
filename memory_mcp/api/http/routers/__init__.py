...
from memory_mcp.api.http.routers.events import register_events_routes
...
from memory_mcp.api.http.routers.session_events import register_session_events_routes
from memory_mcp.api.http.routers.skills import register_skills_routes
